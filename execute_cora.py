...
# Based on https://github.com/tensorflow/tensorflow/blob/5bc9d26649cca274750ad3625bd93422617eed4b/tensorflow/python/ops/nn_ops.py#L3702-L3753
def gelu(features):
    return 0.5 * features * (1.0 + tf.math.erf(
          features / tf.cast(1.4142135623730951, features.dtype)))

# Based on https://github.com/pouyaardehkhani/ActTensor/blob/fe69580ea977b6f97d7ba1de71bf6f215ac06900/act_tensor/layers.py.
def swiglu(x):
...
with tf.Graph().as_default():
    ...
    train_op, opt = model.training(loss, lr_in, l2_coef)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            half_mark = (nb_epochs / 2)
            lr_real = lr_max - (abs(half_mark - epoch) / half_mark) * (lr_max - lr)
